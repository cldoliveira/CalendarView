...
public class CompactCalendarView extends View {
	...
	//Novo método adicionado para satisfazer o layout de UX projeto
    public void setCalendarHeaderTextColor(final int calendarHeaderTextColor) {
        compactCalendarController.setCalendarHeaderTextColor(calendarHeaderTextColor);
        invalidate();
    }


    //Adicionado para modificar o typeface do header
    public void setCalendarHeaderTypeface(final Typeface typeface) {
        compactCalendarController.setTypefaceHeader(typeface);
        invalidate();
    }

    //Código inserido para modificar o typeface do corpo do calendário
    public void setCalendarBodyTypeface(final Typeface typeface) {
        compactCalendarController.setTypefaceBody(typeface);
        invalidate();
    }

    public void setIndicatorRadius(float indicatorRadius){
        compactCalendarController.setIndicatorRadius(indicatorRadius);
        invalidate();
    }
